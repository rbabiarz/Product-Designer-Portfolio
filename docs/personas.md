...
## Secondary — Design leader / recruiter
- **Role / context:** skimming many candidates, limited time.
- **Goals:** confirm real design-system depth and accessibility discipline, fast.
- **Frustrations:** having to dig for the "why"; inaccessible demos.
- **Success feels like:** value clear in one scroll; an easy reason to reach out.
